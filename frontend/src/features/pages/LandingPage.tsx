...
const SLIDE_INTERVAL_MS = 7000; // 자동 슬라이드 간격
...
const slideContentClass =
    "flex w-[1180px] shrink-0 items-center justify-center gap-12";
const slideCopyClass = "w-[460px] shrink-0";
...
export function LandingPage() {
    ...
    const slides: ReactNode[] = [
        ...
        <div className="text-center" key="intro">
            ...
            <h1 className="text-[3rem] font-light leading-[1.3] text-[#5a4632]" style={serif}>
                당신의 마음속 날씨는
                <br />
                어떤 모습인가요?
            </h1>
        ...
        // 2. 나만의 방 — 문구 + 방 데모
        <div className={slideContentClass} key="room">
            <div className={slideCopyClass}>
                <h2 className="text-[1.5rem] font-normal leading-[1.55] text-[#5a4632]" style={gothic}>
                    나만의 방에서 <br />말하지 못한 이야기를 적어주세요.
                    <br />
                    그 이야기 속 마음은 <br />창밖의 날씨와 방 안의 사물이 됩니다.
                </h2>
            </div>
            <div className={`${captureImageClass} pointer-events-none overflow-hidden bg-[#faf8f2]`}>
                <Room
        ...
        // 3. 광장 — 문구 + 광장 캡처
        <div className={slideContentClass} key="plaza">
            <div className={slideCopyClass}>
                <h2 className="text-[1.5rem] font-normal leading-[1.55] text-[#5a4632]" style={gothic}>
                    익명 소통 장소인 광장에서 글을 남기고,
                    <br />
                    다른 사람들의 이야기를 들어보아요.
                </h2>
            </div>
        ...
        // 4. 우편함 — 문구 + 우편함 캡처
        <div className={slideContentClass} key="mailbox">
            <div className={slideCopyClass}>
                <h2 className="text-[1.5rem] font-normal leading-[1.55] text-[#5a4632]" style={gothic}>
                    우편함에서 여러 사람들과 함께 꾸민 <br />
                    광장의 모습을 AI로 변환한 이미지로 받아요.
                </h2>
            </div>
    ...
    // index가 바뀔 때마다 7초 카운트다운을 다시 시작합니다. (수동 이동 시에도 타이머 리셋)
    useEffect(() => {
    ...
    return (
        <div className="mw-app relative h-screen overflow-hidden">
            ...
            <div className="h-full overflow-hidden">
                ...
                >
                    {slides.map((slide, i) => (
                        <div
                            key={i}
                            className="flex h-full w-full shrink-0 items-center justify-center overflow-hidden px-16"
                            aria-hidden={i !== index}
                        >
                            {slide}
                        </div>
            ...
            <div className="absolute inset-x-0 bottom-20 flex flex-col items-center gap-5">
